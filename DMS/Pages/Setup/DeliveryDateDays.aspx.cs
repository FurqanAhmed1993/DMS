...
public partial class Pages_Setup_DeliveryDateDays : Base
{
    ...
    public void BindRepeater()
    {
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeliveryDateDays.aspx", "BindRepeater", ex.Message);
        }
    }
    public DataTable GetDetail()
    {
        ...
        dt = new BAL_DeliveryDateDays().usp_Setup_DeliveryDateDays(OperationTypesID.Select, null, Convert.ToInt32(Name), UserId, UserIP);
        return dt;
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Id == 0)
            {
                DataTable dt = new BAL_DeliveryDateDays().usp_Setup_DeliveryDateDays(OperationTypesID.Insert, null, Convert.ToInt32(Value), UserId, UserIP);
                if (dt != null && dt.Rows.Count > 0)
                {
            ...
            {
                DataTable dt = new BAL_DeliveryDateDays().usp_Setup_DeliveryDateDays(OperationTypesID.Update, Id, Convert.ToInt32(Value), UserId, UserIP);
                if (dt != null && dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["HasError"].ToString() == "1")
                    {
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeliveryDateDays.aspx", "btnAdd_Click", ex.Message);
        }
    }
    protected void lbEdit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (_hfId > 0)
            {
                DataTable dt = new BAL_DeliveryDateDays().usp_Setup_DeliveryDateDays(OperationTypesID.Select, _hfId, null, null, null);
                if (dt != null && dt.Rows.Count > 0)
                {
                    txtValue.Text = Convert.ToString(dt.Rows[0]["DeliveryDateDays"].ToString());
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeliveryDateDays.aspx", "lbEdit_Click", ex.Message);
        }
    }
    protected void lbDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeliveryDateDays.aspx", "lbDelete_Click", ex.Message);
        }
    }
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Id > 0)
            {
                ...
                {
                    DataTable dt = new BAL_DeliveryDateDays().usp_Setup_DeliveryDateDays(OperationTypesID.Delete, Id, null, UserId, UserIP);
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        if (dt.Rows[0]["HasError"].ToString() == "1")
                        {
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeliveryDateDays.aspx", "btnDelete_Click", ex.Message);
        }
    }
    public bool IsTransectionExist(int Id)
    {
        bool status = false;
        DataTable dt = new BAL_DeliveryDateDays().usp_IsTransection_Exist_DeliveryDateDays(OperationTypesID.OtIsExistById, Id);
        if (dt != null && dt.Rows.Count > 0)
        {
            status = true;
        }
