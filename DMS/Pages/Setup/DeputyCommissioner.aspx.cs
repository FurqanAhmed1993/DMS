...
public partial class Pages_Setup_DeputyCommissioner : Base
{
    ...
    public void BindRepeater()
    {
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeputyCommissioner.aspx", "BindRepeater", ex.Message);
        }
    }
    public DataTable GetDetail()
    {
        ...
        dt = new BAL_DeputyCommissioner().usp_Setup_DeputyCommissioner(OperationTypesID.Select, null, Name, null, null, null, UserId, UserIP);
        return dt;
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Id == 0)
            {
                DataTable dt = new BAL_DeputyCommissioner().usp_Setup_DeputyCommissioner(OperationTypesID.Insert, null, Value, FromDate, ToDate, null, UserId, UserIP);
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    else if (dt.Rows[0]["HasError"].ToString() == "0")
                    {
                        ...
                        DataTable dtActivity = new BAL_ActivityLog().usp_SetupActivityLog("Deputy Commissioner Added", currentPageName, UserId, UserIP);
            ...
            {
                DataTable dt = new BAL_DeputyCommissioner().usp_Setup_DeputyCommissioner(OperationTypesID.Update, Id, Value, FromDate, ToDate, null, UserId, UserIP);
                if (dt != null && dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["HasError"].ToString() == "1")
                    {
                    ...
                    {
                        string currentPageName = System.IO.Path.GetFileName(Request.Url.AbsolutePath);
                        DataTable dtActivity = new BAL_ActivityLog().usp_SetupActivityLog("Deputy Commissioner Updated", currentPageName, UserId, UserIP);
                        Success(dt.Rows[0]["Message"].ToString());
                        BindRepeater();
                        ResetModalControls();
                        ClosePopup();
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeputyCommissioner.aspx", "btnAdd_Click", ex.Message);
        }
    }
    protected void lbEdit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (_hfId > 0)
            {
                DataTable dt = new BAL_DeputyCommissioner().usp_Setup_DeputyCommissioner(OperationTypesID.Select, _hfId, null, null, null, null, UserId, UserIP);
                if (dt != null && dt.Rows.Count > 0)
                {
                    txtValue.Text = Convert.ToString(dt.Rows[0]["CommisionerName"].ToString());

                    DateTime FromDate = Convert.ToDateTime(dt.Rows[0]["FromDate"].ToString()).Date;
                    DateTime ToDate = Convert.ToDateTime(dt.Rows[0]["ToDate"].ToString()).Date;

                    txtFromDate.Text = FromDate.ToString("dd-MMMM-yyyy");
                    txtToDate.Text = ToDate.ToString("dd-MMMM-yyyy");
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeputyCommissioner.aspx", "lbEdit_Click", ex.Message);
        }
    }
    protected void lbDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeputyCommissioner.aspx", "lbDelete_Click", ex.Message);
        }
    }
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Id > 0)
            {
                ...
                //{
                DataTable dt = new BAL_DeputyCommissioner().usp_Setup_DeputyCommissioner(OperationTypesID.Delete, Id, null, null, null, null, UserId, UserIP);
                if (dt != null && dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["HasError"].ToString() == "1")
                    {
                    ...
                    else if (dt.Rows[0]["HasError"].ToString() == "0")
                    {
                        ...
                        string currentPageName = System.IO.Path.GetFileName(Request.Url.AbsolutePath);
                        DataTable dtActivity = new BAL_ActivityLog().usp_SetupActivityLog("Deputy Commissioner Deleted", currentPageName, UserId, UserIP);
                        Success(dt.Rows[0]["Message"].ToString());
                        BindRepeater();
                    }
                }
        ...
        {
            Logger.WriteErrorLog("/Pages/Setup/DeputyCommissioner.aspx", "btnDelete_Click", ex.Message);
        }
    }
