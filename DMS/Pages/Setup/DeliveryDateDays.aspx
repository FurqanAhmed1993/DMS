<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="DeliveryDateDays.aspx.cs" Inherits="Pages_Setup_DeliveryDateDays" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Delivery Date Days
            </h5>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group">
                                    <label class="mb-5">
                                        Delivery Date Days</label>
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" onkeypress="return functionx(event)" autocomplete="off"></asp:TextBox>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped display pb-30">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="rpt" runat="server" OnItemDataBound="rpt_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    <input type="hidden" runat="server" id="_hfId" class="_hfId" value='<%# Eval("DeliveryDateDayId") %>' />
                                                    <td>
                                                        <%#(((RepeaterItem)Container).ItemIndex+1).ToString()%>
                                                    </td>
                                                    <td>
                                                        <%# Eval("DeliveryDateDays") %>
                                                    </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px; text-align: center">
                    <h5 class="modal-title">Add / Update Delivery Date Days</h5>
                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        <label class="mb-5">Delivery Date Days</label>
                                        ...
                                        <asp:TextBox ID="txtValue" runat="server" CssClass="form-control txtValue clsTextBox" AutoCompleteType="Disabled" onkeypress="return functionx(event)" Width="50%"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
